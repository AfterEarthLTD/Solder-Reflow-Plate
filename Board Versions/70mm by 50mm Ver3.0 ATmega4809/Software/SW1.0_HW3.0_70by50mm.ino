...
/* To prepare
 * 1) Install MegaCoreX in additional boards; (copy into File->Preferences->Additional Boards Manager URLs)
 *     https://mcudude.github.io/MegaCoreX/package_MCUdude_MegaCoreX_index.json
 * 2) Then add MegaCoreX by searching and installing (Tools->Board->Board Manager)
 ...
 *  2) Set programmer of choice, e.g.'PICkit4 UPDI', 'microUPDI', etc, and set correct port.
